// =============================================================================
// AIBP CEID — POST-SHOW REPORT BACKEND (standalone, Indonesia)
//
// Adapted from the CEMY (Malaysia) report backend. Unlike CEMY, this one has
// NO read-only link into a live operational CE app spreadsheet — Indonesia's
// live app runs on Firebase, not the Sheets-backed app CEMY uses, so there is
// no equivalent "main sheet" to pull Sponsors/Config from. Everything this
// script reads — sessions, awards, networking, testimonials, sponsors, and
// the handful of event-level settings in EVENT_DEFAULTS below — lives on the
// one standalone "CEID_Report_Content" spreadsheet (REPORT_SHEET_ID).
//
// SETUP (one time):
...
//   5. In Vercel (aibp-ce-post-id project), set env var REPORT_GAS_URL to
...
//
// This file touches NOTHING in the live id.aibp.sg app or my.aibp.sg/its GAS
// project — it only ever opens REPORT_SHEET_ID, and only for reading.
// =============================================================================
...
const REPORT_SHEET_ID = '1Y1SVkFwS-1Nst1VJKB_Bfav1pUEDK9BfIarYBnSPL2g';
...
const EVENT_DEFAULTS = {
  eventName: 'AIBP Conference & Exhibition Indonesia 2026',
  day1: '2026-08-26',
  day2: '2026-08-27',
  // Exact venue name unconfirmed as of this script being written — add a
  // "Venue" row to REPORT_META once it's confirmed, or edit this default.
